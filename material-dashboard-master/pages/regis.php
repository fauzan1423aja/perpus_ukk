            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                ...
                if(isset($_POST['register'])) {
                  ...
                  $insert = mysqli_query($koneksi, "INSERT INTO user(nama_lengkap,email,alamat,username,password,role) VALUES('$nama','$email','$alamat','$username','$password','$role')");
                ...
                <form role="form" class="text-start" method="post">
                  ...
                  <div class="input-group input-group-outline my-3">
                  <label class="form-label"></label>
                    <input type="text" class="form-control"required name="email" placeholder="Masukkan Email">
                  </div>
                  <div class="input-group input-group-outline my-3">
                  <label class="form-label"></label>
                  ...
                  <div class="mb-3 text-center">
                    <select required name="role" class="pe-12 p-2" style="border-radius: 5px; " >
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2" name="register" value="register">Register</button>
                  </div>
                  <p class="mt-4 text-sm text-center">
                    Anda sudah memiliki Akun?
                    <a href="../pages/login.php" class="text-primary text-gradient font-weight-bold">Login</a>
                  </p>
                  <br>
